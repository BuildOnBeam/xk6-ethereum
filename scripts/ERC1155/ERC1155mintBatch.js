...
export default function () {
  ...
  try {
    ...
    // mintBatch(address to, uint256[] tokenIds, uint256[] amounts)
    const tx_mint = con.txn("mintBatch",txOpt,account.address,[tokenid,tokenid+1],[2,2]);
    console.log(`txn hash (mintBatch erc1155) => ${tx_mint}`);
