...
export default function () {
  ...
  try {
    ...
    // safeBatchTransferFrom(address from, address to, uint256[] ids, uint256[] amounts, bytes data) // data should be an ampty string -> ""
    const tx_hash = con.txn("safeBatchTransferFrom",txOpt,account.address,targetAddress,[tokenid,tokenid+1,tokenid+2,tokenid+3],[1,1,1,1],"");
    console.log(`txn hash (safeBatchTransferFrom erc1155) => ${tx_hash}`);
